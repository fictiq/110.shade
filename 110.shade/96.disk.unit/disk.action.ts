...
export const EXIST_DISK = "[Exist action] Exist Disk";
 export class ExistDisk implements Action {
 readonly type = EXIST_DISK;
 constructor(public bale: DiskBit) {}
 }
 
export const SWATCH_DISK = "[Swatch action] Swatch Disk";
 export class SwatchDisk implements Action {
 readonly type = SWATCH_DISK;
 constructor(public bale: DiskBit) {}
 }
 
export const COLOR_DISK = "[Color action] Color Disk";
 export class ColorDisk implements Action {
 readonly type = COLOR_DISK;
 constructor(public bale: DiskBit) {}
 }
 
export const TYPE_DISK = "[Type action] Type Disk";
 export class TypeDisk implements Action {
 readonly type = TYPE_DISK;
 constructor(public bale: DiskBit) {}
 }
